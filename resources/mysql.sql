...
-- #{ inventories
-- #    { create
CREATE TABLE IF NOT EXISTS inventories (name VARCHAR(255) NOT NULL DEFAULT "", xuid VARCHAR(255) NOT NULL DEFAULT "", world VARCHAR(255), inventory TEXT, armor TEXT);
-- #    }
-- #    { insert
-- # 	  :name string
-- # 	  :xuid string
